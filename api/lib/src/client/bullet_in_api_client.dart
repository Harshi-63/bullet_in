...
import 'package:bullet_in_api/client.dart';
import 'package:http/http.dart' as http;

/// {@template bullet_in_api_malformed_response}
/// An exception thrown when there is a problem decoded the response body.
/// {@endtemplate}
class BulletInApiMalformedResponse implements Exception {
  /// {@macro bullet_in_api_malformed_response}
  const BulletInApiMalformedResponse({required this.error});

  /// The associated error.
  final Object error;
}

/// {@template bullet_in_api_request_failure}
/// An exception thrown when an http request failure occurs.
/// {@endtemplate}
class BulletInApiRequestFailure implements Exception {
  /// {@macro bullet_in_api_request_failure}
  const BulletInApiRequestFailure({
...
/// {@template bullet_in_api_client}
/// A Dart API client for the BulletIn API.
/// {@endtemplate}
class BulletInApiClient {
  /// Create an instance of [BulletInApiClient] that integrates
  /// with the remote API.
  ///
  /// {@macro bullet_in_api_client}
  BulletInApiClient({
  ...
  Future<ArticleResponse> getArticle({
    ...
    if (response.statusCode != HttpStatus.ok) {
      throw BulletInApiRequestFailure(
        body: body,
  ...
  Map<String, dynamic> json() {
    try {
      ...
      Error.throwWithStackTrace(
        BulletInApiMalformedResponse(error: error),
        stackTrace,
      );
    }
  }
