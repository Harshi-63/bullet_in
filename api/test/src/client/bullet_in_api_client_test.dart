...
void main() {
  ...
  group('BulletInApiClient', () {
    late http.Client httpClient;
    late BulletInApiClient apiClient;
    ...
    group('localhost constructor', () {
      ...
      test('has correct baseUrl', () async {
        ...
        final apiClient = BulletInApiClient.localhost(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('default constructor', () {
      test('can be instantiated (no params).', () {
        expect(
          () => BulletInApiClient(tokenProvider: tokenProvider),
          returnsNormally,
        );
      });
      ...
      test('has correct baseUrl.', () async {
        ...
        final apiClient = BulletInApiClient(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('getArticle', () {
      ...
      test(
          'throws BulletInApiMalformedResponse '
        ...
        expect(
          ...
          throwsA(isA<BulletInApiMalformedResponse>()),
        );
      });

      test(
          'throws BulletInApiRequestFailure '
